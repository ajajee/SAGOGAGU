...
public class ReviewBoardControllerImpl implements ReviewBoardController {
	...
	public ResponseEntity<byte[]> getImage(@RequestParam(value = "filename") String filename,
		...
		String filepath = reviewBoardService.getUploadPath(filename); // 吏곸젒 uploadpath 媛��졇�삤寃� �굹以묒뿉 �닔�젙 �뀑�뀑
	...
	public void thumbnails(@RequestParam("filename") String filename, HttpServletResponse response)
			throws IOException {
	...
	/*
	 * @Override public ModelAndView uploadReview(List<MultipartFile> files, String
